...
module.exports = {
  ...
  getDetailById: async (id) => {
    try {
      const result = await sql.query(`
      SELECT DETAIL_INVOICE.TYPE_ID, DETAIL_INVOICE_TYPE.NAME, DETAIL_INVOICE_TYPE.UNIT, DETAIL_INVOICE.QUANTITY, DETAIL_INVOICE.UNIT_PRICE, DETAIL_INVOICE.SUM_MONEY
